...
<body>
<div class="container-fluid gradient-bg py-5 mb-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form method="POST">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="mb-0">Nouvelle playlist</h1>
                        <div>
                            <button type="submit" name="create_playlist" class="btn btn-primary px-4">
                    ...
                    <div class="mb-4">
                        <input type="text" name="nom" class="playlist-name" placeholder="Nom de la playlist" required
                               value="<?= isset($_POST['nom']) ? htmlspecialchars($_POST['nom']) : '' ?>">
                    </div>

                    <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" name="public" id="publicSwitch" <?= isset($_POST['public']) ? 'checked' : '' ?>>
                        <label class="form-check-label" for="publicSwitch">Playlist publique</label>
                    </div>

                    <input type="hidden" name="songs" id="selectedSongs" value="<?= isset($_POST['songs']) ? htmlspecialchars($_POST['songs']) : '[]' ?>">
                </form>
            </div>
        </div>
    </div>
